...
<!-- Mirrored from transvelo.github.io/electro-html/2.0/html/home/home-v4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Feb 2023 11:46:38 GMT -->
                                                            ...
                                                            <li class="u-has-submenu u-header-collapse__submenu">
                                                                ...
                                                                <div id="headerSidebarBlogCollapse" class="collapse" data-parent="#headerSidebarContent">
                                                                    <ul id="headerSidebarBlogMenu" class="u-header-collapse__nav-list">
                                                                        ...
                                                                        <!-- 7 Column Full width -->
                                                                        <li><a class="u-header-collapse__submenu-nav-link" href="product">7 Column Full width</a></li>
                                                            ...
                                                            <li class="u-has-submenu u-header-collapse__submenu">
                                                                ...
                                                                <div id="headerSidebarShopCollapse" class="collapse" data-parent="#headerSidebarContent">
                                                                    <ul id="headerSidebarShopMenu" class="u-header-collapse__nav-list">
                                                                        ...
                                                                        <li><a class="u-header-collapse__submenu-nav-link" href="product">Single Product Fullwidth</a></li>
                                                            ...
                                                            <li class="u-has-submenu u-header-collapse__submenu">
                                                                ...
                                                                <div id="headerSidebarDemosCollapse" class="collapse" data-parent="#headerSidebarContent">
                                                                    <ul id="headerSidebarDemosMenu" class="u-header-collapse__nav-list">
                                                                        <!-- Shop -->
                                                                        <li><a class="u-header-collapse__submenu-nav-link" href="shop">Shop</a></li>
                                                                        <!-- End Shop -->
                                                                ...
                                                                <li class="nav-item hs-has-sub-menu u-header__nav-item"
                                                                    ...
                                                                    <ul id="homeSubMenu" class="hs-sub-menu u-header__sub-menu animated hs-position-left fadeOut" aria-labelledby="homeMegaMenu" style="min-width: 230px; display: none;">
                                                                        ...
                                                                        <li class="hs-has-sub-menu">
                                                                            <a class="nav-link u-header__sub-menu-nav-link " href="">Home-v1</a>
                                                                        </li>
                                                                        <!-- End Home-v1 -->
                                                    ...
                                                    <div class="row u-header__mega-menu-wrapper">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <ul class="u-header__sub-menu-nav-group">
                                                                ...
                                                                <li><a href="product" class="nav-link u-header__sub-menu-nav-link">7 Column Full width</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="col-md-3">
                                                            ...
                                                            <ul class="u-header__sub-menu-nav-group mb-3">
                                                                ...
                                                                <li><a href="product" class="nav-link u-header__sub-menu-nav-link">Single Product Fullwidth</a></li>
                                                            ...
                                                            <ul class="u-header__sub-menu-nav-group">
                                                                <li><a href="shop" class="nav-link u-header__sub-menu-nav-link">Shop</a></li>
                                                                <li><a href="/cart" class="nav-link u-header__sub-menu-nav-link">Cart</a></li>
                                    ...
                                    <div class="js-slide bg-img-hero-center">
                                        <div class="row height-410-xl py-7 py-md-0 mx-0">
                                            ...
                                            <div class="col-xl col-6 col-md-6 mt-md-8">
                                                ...
                                                <a href="product" class="btn btn-primary transition-3d-hover rounded-lg font-weight-normal py-2 px-md-7 px-3 font-size-16"
                                                    data-scs-animation-in="fadeInUp"
                            ...
                            <div class="overflow-hidden">
                                <ul class="list-unstyled row flex-nowrap flex-xl-wrap overflow-auto overflow-lg-visble mx-n2 mx-xl-0 d-xl-block mb-0">
                                    <li class="px-2 px-xl-0 flex-shrink-0 flex-xl-shrink-1 mb-3">
                                        <a href="shop" class="min-height-126 max-width-320 py-1 py-xl-2 py-wd-1 banner-bg d-flex align-items-center text-gray-90">
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-xl-4 p-3">
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Speakers</a></div>
                                                <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                <div class="mb-2">
                                                    <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img1.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    ...
                                                    <div class="d-none d-xl-block prodcut-add-cart">
                                                        <a href="product" class="btn-add-cart btn-primary transition-3d-hover"><i class="ec ec-add-to-cart"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="col-6 col-md-4 col-lg-3 col-xl product-item">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-xl-4 p-3">
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Speakers</a></div>
                                                <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Tablet White EliteBook Revolve 810 G2</a></h5>
                                                <div class="mb-2">
                                                    <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img2.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                ...
                                <li class="col-6 col-md-4 col-lg-3 col-xl product-item remove-divider-md">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-xl-4 p-3">
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Speakers</a></div>
                                                <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Purple Solo 2 Wireless</a></h5>
                                                <div class="mb-2">
                                                    <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img3.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                ...
                                <li class="col-6 col-md-4 col-lg-3 col-xl product-item d-md-none d-lg-block remove-divider-lg">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-xl-4 p-3">
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Speakers</a></div>
                                                <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Smartphone 6S 32GB LTE</a></h5>
                                                <div class="mb-2">
                                                    <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img4.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                ...
                                <li class="col-6 col-md-4 col-lg-3 col-xl product-item d-md-none d-xl-block">
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner px-xl-4 p-3">
                                            <div class="product-item__body pb-xl-2">
                                                <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Speakers</a></div>
                                                <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Widescreen NX Mini F1 SMART NX</a></h5>
                                                <div class="mb-2">
                                                    <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img5.jpg" alt="Image Description"></a>
                                                </div>
                                                <div class="flex-center-between mb-1">
                                                    <div class="prodcut-price">
                                                        <div class="text-gray-100">$685,00</div>
                                            ...
                                            <div class="product-item__outer h-100">
                                                <div class="product-item__inner bg-white px-wd-4 p-2 p-md-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                        <div class="mb-2">
                                                            <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img6.jpg" alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                                <div class="text-gray-100">$685,00</div>
                                            ...
                                            <div class="product-item__outer h-100">
                                                <div class="product-item__inner bg-white px-wd-4 p-2 p-md-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        ...
                                                        <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                        <div class="mb-2">
                                                            <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img7.jpg" alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                                                            <div class="prodcut-price">
                                                                <div class="text-gray-100">$685,00</div>
                        ...
                        <div class="col-12 col-xl-auto pr-lg-2">
                            <div class="min-width-200 mt-xl-5">
                                <ul class="list-group list-group-flush flex-nowrap flex-xl-wrap flex-row flex-xl-column overflow-auto overflow-xl-visble mb-3 mb-xl-0">
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Featured Phones</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Mobile Phones</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Unlocked Phone</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">4G LTE Smartphone</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Tablet PCs</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Tablet Accessories</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Featured Tablets</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Mobiles Accesories</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-auto">
                            <a href="shop" class="d-block"><img class="img-fluid" src="/assets/img/360X616/img1.jpg" alt="Image Description"></a>
                        </div>
                                        ...
                                        <li class="col-6 col-md-4 col-wd-3 product-item remove-divider-wd">
                                            <div class="product-item__outer h-100">
                                                <div class="product-item__inner bg-white p-3">
                                                    <div class="product-item__body pb-xl-2">
                                                        <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Speakers</a></div>
                                                        <h5 class="mb-1 product-item__title"><a href="product" class="text-blue font-weight-bold">GameConsole Destiny  Special Edition</a></h5>
                                                        <div class="mb-2">
                                                            <a href="product" class="d-block text-center"><img class="img-fluid" src="/assets/img/212X200/img7.jpg" alt="Image Description"></a>
                                                        </div>
                                                        <div class="flex-center-between mb-1">
                        ...
                        <div class="col-12 col-xl-auto pr-lg-2">
                            <div class="min-width-200 mt-xl-5">
                                <ul class="list-group list-group-flush flex-nowrap flex-xl-wrap flex-row flex-xl-column overflow-auto overflow-xl-visble mb-3 mb-xl-0 border-top border-color-1 border-lg-top-0">
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Earbuds and In-ear</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Headphones</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Kids' Headphones</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Over-Ear and On-Ear</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">PC Gaming Headsets</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Pro &amp; DJ Headset</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Refurbished Headset</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Waterproof Headset</a></li>
                                    <li class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1"><a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Wireless and Bluetooth</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-auto">
                            <a href="shop" class="d-block"><img class="img-fluid" src="/assets/img/360X616/img2.jpg" alt="Image Description"></a>
                        </div>
                        <div class="col-md pl-md-0">
                            <ul class="row list-unstyled products-group no-gutters mb-0">
                                <li class="col-6 col-md-4 col-wd-3 product-item">
                    ...
                    <div class="row flex-nowrap flex-md-wrap overflow-auto overflow-md-visble">
                        <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                            <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                                <a href="product" class="d-block pr-2 pr-wd-6">
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white p-3">
                                            <div class="product-item__body d-flex flex-column">
                                                <div class="mb-1">
                                                    <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Game Consoles</a></div>
                                                    <h5 class="mb-0 product-item__title"><a href="product" class="text-blue font-weight-bold">Game Console Controller + USB 3.0 Cable</a></h5>
                                                </div>
                                                <div class="mb-1 min-height-xl-450">
                                                    <a href="product" class="d-block text-center my-4 mt-lg-0 mb-xl-5 mb-lg-0 mt-xl-0 mb-xl-0 mt-wd-0 mb-wd-3"><img class="img-fluid" src="/assets/img/564X520/img2.jpg" alt="Image Description"></a>
                                                    <!-- Gallery -->
                                                ...
                                                <div class="flex-center-between mb-2">
                                                    ...
                                                    <div class="d-none d-xl-block prodcut-add-cart">
                                                        <a href="product" class="btn-add-cart btn-add-cart__wide btn-primary transition-3d-hover"><i class="ec ec-add-to-cart mr-2"></i> Add to Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="product-item__footer">
                                    ...
                                    <div class="product-item__outer h-100">
                                        <div class="product-item__inner bg-white p-3">
                                            <div class="product-item__body d-flex flex-column">
                                                <div class="mb-1">
                                                    <div class="mb-2"><a href="product" class="font-size-12 text-gray-5">Game Consoles</a></div>
                                                    <h5 class="mb-0 product-item__title"><a href="product" class="text-blue font-weight-bold">Ultra Wireless S50 Headphones S50 with Bluetooth</a></h5>
                                                </div>
                                                <div class="mb-1 min-height-xl-450">
                                                    <a href="product" class="d-block text-center my-4 mt-lg-0 mb-xl-5 mb-lg-0 mt-xl-0 mb-xl-0 mt-wd-0 mb-wd-3"><img class="img-fluid" src="/assets/img/564X520/img3.jpg" alt="Image Description"></a>
                                                    <!-- Gallery -->
                                                    <div class="row mx-gutters-2 mb-3">
                                                        <div class="col-auto">
                                                            <!-- Gallery -->
                ...
                <div class="row">
                        ...
                        <div class="widget-column">
                            ...
                            <ul class="list-unstyled products-group">
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img1.jpg" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                        <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Purple Wireless Headphones Solo 2 HD</a></h5>
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img2.jpg" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                        <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Powerbank 1130 mAh Blue</a></h5>
                                        <div class="prodcut-price mt-auto">
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img3.jpg" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                        <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Nerocool EN52377 Dead Silence Gaming Cube Case</a></h5>
                                        <div class="prodcut-price mt-auto">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img4.jpg" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Yellow Earphones Waterproof with Bluetooth</a></h5>
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img5.jpg" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Camera C430W 4k Waterproof</a></h5>
                                    <div class="prodcut-price mt-auto flex-horizontal-center">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img6.jpg" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Smartphone 6S 32GB LTE</a></h5>
                                    <div class="prodcut-price mt-auto flex-horizontal-center">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img7.jpg" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Smartwatch 2.0 LTE Wifi Waterproof</a></h5>
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img8.jpg" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">22Mps Camera 6200U with 500GB SDcard</a></h5>
                                    <div class="text-warning mb-2">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="product" class="d-block width-75 text-center"><img class="img-fluid" src="/assets/img/75X75/img9.jpg" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                                    <h5 class="product-item__title mb-0"><a href="product" class="text-blue font-weight-bold">Full Color LaserJet Pro M452dn</a></h5>
                                    <div class="text-warning mb-2">
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                                        <small class="fas fa-star"></small>
                    ...
                    <div class="col-wd-3 d-none d-wd-block">
                        <a href="shop" class="d-block"><img class="img-fluid" src="/assets/img/330X360/img1.jpg" alt="Image Description"></a>
                    </div>
                </div>
            </div>
