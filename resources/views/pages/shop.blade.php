                        ...
                        <ul class="list-unstyled">
                            <li class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="product">Notebook Black Spire
                                                V
                                                Nitro VN7-591G</a></h3>
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="product">Tablet Thin
                                                EliteBook
                                                Revolve 810 G6</a></h3>
                                        <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                            <small class="fas fa-star"></small>
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="product">Notebook Purple
                                                G952VX-T7008T</a></h3>
                                        <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                            <small class="fas fa-star"></small>
                                            <small class="fas fa-star"></small>
                            ...
                            <li class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h3 class="text-lh-1dot2 font-size-14 mb-0"><a href="product">Laptop Yoga 21
                                                80JH0035GE
                                                W8.1</a></h3>
                                        <div class="text-warning text-ls-n2 font-size-16 mb-1" style="width: 80px;">
                                            <small class="fas fa-star"></small>
