            ...
            <div class="card-body">
                <div id="invoice">
                    <div class="toolbar hidden-print">
                        <div class="text-end">
                            <a href="#" class="btn btn-dark"><i class="fa fa-print"></i> Home</a>
                            ...
                            <header>
                                <div class="row">
                                    ...
                                    <div class="col company-details">
                                        ...
                                        <div>14 Arundel Road Harare</div>
                                        <div>(263) 00-000</div>
                                        <div>info@electronicsresource.com</div>
                                    </div>
                                </div>
                            </header>
                            <main>
                                <div class="row contacts">
                                    ...
                                    <div class="col invoice-details">
                                        <h1 class="invoice-id">Quote 00263</h1>
                                        <div class="date">Date of Quote: 20/03/2023</div>
