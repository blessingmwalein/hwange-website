                            ...
                            <div class="js-slick-carousel u-slick" data-autoplay="true" data-speed="7000"
                                ...
                                <div class="js-slide bg-img-hero-center">
                                    <div class="row height-410-xl py-7 py-md-0 mx-0">
                                        ...
                                        <div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0"
                                            ...
                                            <img class="img-fluid" src="/assets/img/500X380/img1.png"
                                    ...
                                    <div class="row height-410-xl py-7 py-md-0 mx-0">
                                        ...
                                        <div class="col-xl col-6 col-md-6 mt-md-8">
                                            ...
                                            <h6 class="font-size-15 font-weight-bold mb-3"
                                                data-scs-animation-in="slideInLeft" data-scs-animation-delay="200">UNDER
                                                FAVORABLE SMARTWATCHES
                                            </h6>
                                            ...
                                            <a href="product"
                                                class="text-white btn btn-primary transition-3d-hover rounded-lg font-weight-normal py-2 px-md-7 px-3 font-size-16"
                                                data-scs-animation-in="fadeInUp" data-scs-animation-delay="400">
                                                Start Buying
                                            </a>
                                        </div>
                                        <div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0"
                                            ...
                                            <img class="img-fluid" src="/assets/img/500X380/img2.png"
                                                alt="Image Description">
                                        </div>
                                    </div>
                                </div>
                                <div class="js-slide bg-img-hero-center">
                                    <div class="row height-410-xl py-7 py-md-0 mx-0">
                                        ...
                                        <div class="col-xl-7 col-6 d-flex align-items-center ml-auto ml-md-0"
                                            data-scs-animation-in="zoomIn" data-scs-animation-delay="500">
                                            <img class="img-fluid" src="/assets/img/500X380/img3.png"
                                                alt="Image Description">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            <div class="mb-2"><a href="product"
                                                    class="font-size-12 text-gray-5">Speakers</a></div>
                                            <h5 class="mb-1 product-item__title"><a href="product"
                                                    class="text-blue font-weight-bold">Widescreen NX Mini F1 SMART NX</a>
                                            </h5>
                                            <div class="mb-2">
                                                <a href="product" class="d-block text-center"><img class="img-fluid"
                    ...
                    <div
                        ...
                        <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 mb-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0"
                            ...
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill active" id="Bpills-one-example1-tab"
                                    data-toggle="pill" href="#Bpills-one-example1" role="tab"
                                    aria-controls="Bpills-one-example1" aria-selected="true">Bestsellers</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Bpills-two-example1-tab" data-toggle="pill"
                                    href="#Bpills-two-example1" role="tab" aria-controls="Bpills-two-example1"
                                    aria-selected="false">17 inch</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Bpills-three-example1-tab" data-toggle="pill"
                                    href="#Bpills-three-example1" role="tab" aria-controls="Bpills-three-example1"
                                    aria-selected="false">15 inch</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill" id="Bpills-four-example1-tab" data-toggle="pill"
                                    href="#Bpills-four-example1" role="tab" aria-controls="Bpills-four-example1"
                                    aria-selected="false">12.3 inch</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="min-width-200 mt-xl-5">
                            <ul
                                ...
                                <li
                                    ...
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Featured
                                        Phones</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Mobile
                                        Phones</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Unlocked
                                        Phone</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">4G LTE
                                        Smartphone</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Tablet
                                        PCs</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Tablet
                                ...
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Mobiles
                                        Accesories</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-auto">
                        <a href="shop" class="d-block"><img class="img-fluid" src="/assets/img/360X616/img1.jpg"
                                alt="Image Description"></a>
                    </div>
                    ...
                    <div class="col-12 col-xl-auto pr-lg-2">
                        <div class="min-width-200 mt-xl-5">
                            <ul
                                ...
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Earbuds and
                                        In-ear</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block"
                                        href="product">Headphones</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Kids'
                                        Headphones</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Over-Ear and
                                        On-Ear</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">PC Gaming
                                        Headsets</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Pro &amp; DJ
                                        Headset</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Refurbished
                                        Headset</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Waterproof
                                        Headset</a></li>
                                <li
                                    class="border-color-1 list-group-item border-lg-down-0 flex-shrink-0 flex-xl-shrink-1">
                                    <a class="hover-on-bold py-1 px-3 text-gray-90 d-block" href="product">Wireless and
                                        Bluetooth</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img4.png"
                                            alt="Image Description">
                                    </div>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img5.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img6.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img7.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img8.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img9.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img10.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img11.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img12.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-4 col-xl-2gdot4 mb-3 flex-shrink-0 flex-md-shrink-1">
                        <div class="bg-white overflow-hidden shadow-on-hover h-100 d-flex align-items-center">
                            <a href="product" class="d-block pr-2 pr-wd-6">
                                <div class="media align-items-center">
                                    <div class="pt-2">
                                        <img class="img-fluid transform-rotate-15" src="/assets/img/100X100/img13.png"
                                            alt="Image Description">
                                    </div>
                                    <div class="ml-3 media-body">
                ...
                <div class="position-relative text-center z-index-2">
                    <div
                        ...
                        <ul class="w-100 w-lg-auto nav nav-pills nav-tab-pill mb-2 pt-3 pt-lg-0 mb-0 border-top border-color-1 border-lg-top-0 align-items-center font-size-15 font-size-15-lg flex-nowrap flex-lg-wrap overflow-auto overflow-lg-visble pr-0"
                            ...
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                                <a class="nav-link rounded-pill active" id="Qpills-one-example1-tab"
                                    data-toggle="pill" href="#Qpills-one-example1" role="tab"
                                    aria-controls="Qpills-one-example1" aria-selected="true">Bestsellers</a>
                            </li>
                            <li class="nav-item flex-shrink-0 flex-lg-shrink-1">
                ...
                <div class="row">
                                    ...
                                    <div class="product-item__inner bg-white p-3">
                                        <div class="product-item__body d-flex flex-column">
                                            <div class="mb-1">
                                                ...
                                                <h5 class="mb-0 product-item__title"><a href="product"
                                                        class="text-blue font-weight-bold">Game Console Controller + USB
                                                        3.0 Cable</a></h5>
                                            </div>
                                            <div class="mb-1 min-height-xl-450">
                                                <a href="product"
                                                    class="d-block text-center my-4 mt-lg-0 mb-xl-5 mb-lg-0 mt-xl-0 mb-xl-0 mt-wd-0 mb-wd-3"><img
                                                ...
                                                <div class="row mx-gutters-2 mb-3">
                                                    <div class="col-auto">
                                                        ...
                                                        <a class="js-fancybox max-width-60 u-media-viewer"
                                                            ...
                                                            data-caption="Product Gallery - image #01" data-speed="700"
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <a class="js-fancybox max-width-60 u-media-viewer"
                                                            ...
                                                            data-fancybox="fancyboxGallery6"
                                                            data-caption="Product Gallery - image #02" data-speed="700"
                                                            data-is-infinite="true">
                                                            <img class="img-fluid border"
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <a class="js-fancybox max-width-60 u-media-viewer"
                                                            ...
                                                            data-fancybox="fancyboxGallery6"
                                                            data-caption="Product Gallery - image #03" data-speed="700"
                                                            data-is-infinite="true">
                                                            <img class="img-fluid border"
                    ...
                    <div class="col-md pl-md-0">
                        ...
                        <div class="tab-content" id="Qpills-tabContent">
                            ...
                            <div class="tab-pane fade pt-2" id="Qpills-two-example1" role="tabpanel"
                                aria-labelledby="Qpills-two-example1-tab">
                                <ul class="row list-unstyled products-group no-gutters mb-0">
                                    <li class="col-6 col-md-4 col-wd-3 product-item">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner bg-white p-3">
                            ...
                            <div class="tab-pane fade pt-2" id="Qpills-three-example1" role="tabpanel"
                                aria-labelledby="Qpills-three-example1-tab">
                                <ul class="row list-unstyled products-group no-gutters mb-0">
                                    <li class="col-6 col-md-4 col-wd-3 product-item">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner bg-white p-3">
                            ...
                            <div class="tab-pane fade pt-2" id="Qpills-four-example1" role="tabpanel"
                                aria-labelledby="Qpills-four-example1-tab">
                                <ul class="row list-unstyled products-group no-gutters mb-0">
                                    <li class="col-6 col-md-4 col-wd-3 product-item">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner bg-white p-3">
